...
export const LAYER_REGISTRY: Record<keyof MapLayers, LayerDefinition> = {
  ...
  ransomwareVictims:        def('ransomwareVictims',        '&#128128;', 'ransomwareVictims',        'Ransomware Victims'),
  aptGroups:                def('aptGroups',                '&#127919;', 'aptGroups',                'APT Groups'),
...
const VARIANT_LAYER_ORDER: Record<MapVariant, Array<keyof MapLayers>> = {
  full: [
    ...
    'outages', 'cyberThreats', 'ransomwareVictims', 'aptGroups', 'natural', 'fires',
  ...
  tech: [
    ...
    'ransomwareVictims', 'aptGroups', 'techEvents', 'natural', 'fires', 'dayNight',
  ],
  finance: [
