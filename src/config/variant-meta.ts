...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  ...
  cyber: {
    title: 'Cyber Monitor - Real-Time Cybersecurity & Threat Intelligence Dashboard',
    description: 'Real-time cybersecurity dashboard tracking cyber threats, ransomware attacks, CVE vulnerabilities, APT groups, data breaches, and OSINT intelligence feeds.',
    keywords: 'cybersecurity dashboard, threat intelligence, ransomware tracker, CVE vulnerabilities, APT groups, data breaches, OSINT, cyber threats, malware, IOC feed, threat actors, vulnerability monitoring, security news, infosec, cyber attacks, incident response',
    url: 'https://cyber.worldmonitor.app/',
    siteName: 'Cyber Monitor',
    shortName: 'CyberMonitor',
    subject: 'Cybersecurity, Threat Intelligence, and OSINT',
    classification: 'Cybersecurity Dashboard, Threat Intelligence Platform, OSINT Tool',
    categories: ['security', 'news'],
    features: [
      'Real-time cyber threat tracking',
      'Ransomware attack monitoring',
      'CVE vulnerability feed',
      'APT group intelligence',
      'Data breach alerts',
      'OSINT aggregation',
      'Malware IOC tracking',
